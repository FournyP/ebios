...

      {
        isLogged ? (
          <Container maxWidth="md">
            ...
            <Typography variant="h4" className={classes.tittle}>Bienvenue, vous êtes connecté en tant que : {localStorage.getItem("username")}.</Typography>
            <Typography variant="h6" >
              Vous aurez accès ici à la création de projet, la création d'organisation ainsi qu'à la liste de vos projets.
            </Typography>
