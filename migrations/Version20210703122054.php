 ...
 */
final class Version20210703122054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, workshop1_id INT DEFAULT NULL, workshop2_id INT DEFAULT NULL, workshop3_id INT DEFAULT NULL, workshop4_id INT DEFAULT NULL, workshop5_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, workshops_defined LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_2FB3D0EE32C8A3DE (organization_id), UNIQUE INDEX UNIQ_2FB3D0EE8FC0CC61 (workshop1_id), UNIQUE INDEX UNIQ_2FB3D0EE9D75638F (workshop2_id), UNIQUE INDEX UNIQ_2FB3D0EE25C904EA (workshop3_id), UNIQUE INDEX UNIQ_2FB3D0EEB81E3C53 (workshop4_id), UNIQUE INDEX UNIQ_2FB3D0EEA25B36 (workshop5_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE risk (id INT AUTO_INCREMENT NOT NULL, workshop2_id INT NOT NULL, source VARCHAR(255) NOT NULL, goal VARCHAR(255) NOT NULL, evaluation LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_7906D5419D75638F (workshop2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE workshop1 (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, workshop_contributors LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_1F4E861C166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workshop2 (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, evaluation_base LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_8647D7A6166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
